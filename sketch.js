...
function detectCollision(stones,mango){
    ...
    if (stones.body.position.x - mango.body.position.x <mango.diametre+stones.diameter
        && mango.body.position.x - stones.body.position.x <mango.diametre+stones.diametre
		&&stones.body.position.y - mango.body.position.y <mango.diametre+stones.diameter
